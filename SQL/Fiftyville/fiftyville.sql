...
JOIN bakery_security_logs ON bakery_security_logs. license_plase = people.license_plate
WHERE bakery_security:logs.year = 2024
...
JOIN passengers ON people.passport_number = passangers.passport_number
...
JOIN people ON people.id = bank_account.person_id
